...
fest_created: 2026-02-21T16:44:00.347042-07:00
fest_tracking: true
---
...
```bash
# Verify all README links are valid
grep -rn '\[.*\](.*\.md)' projects/*/README.md | head -20
```
...
- Minimum coverage: N/A (documentation — all 7 READMEs must be reviewed and accurate) for new code

```bash
# Check all 7 READMEs exist and are non-empty
for r in README.md projects/agent-coordinator/README.md projects/agent-inference/README.md projects/agent-defi/README.md projects/dashboard/README.md projects/contracts/README.md projects/hiero-plugin/README.md; do [ -s "$r" ] && echo "OK: $r" || echo "MISSING: $r"; done
```
