...
fest_created: 2026-02-21T16:44:00.343897-07:00
fest_tracking: true
---
...
```bash
cd projects/hiero-plugin && just test -run Integration
```
...
```bash
cd projects/hiero-plugin && go test -coverprofile=coverage.out ./... && go tool cover -func=coverage.out
```
