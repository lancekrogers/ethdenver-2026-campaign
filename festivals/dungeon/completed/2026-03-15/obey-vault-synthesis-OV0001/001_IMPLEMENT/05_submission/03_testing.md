...
fest_created: 2026-03-13T19:27:21.708831-06:00
fest_updated: 2026-03-15T19:52:21.870027-06:00
fest_tracking: true
---
...
```bash
cd projects/agent-defi && go build ./cmd/observer/ && go test ./... -v
```
...
```bash
RPC_URL=https://sepolia.base.org VAULT_ADDRESS=$VAULT go run ./cmd/observer/
```
...
- Minimum coverage: N/A (CLI tool) for new code

N/A — observer is a CLI display tool
