...
fest_created: 2026-03-13T19:27:21.703554-06:00
fest_updated: 2026-03-15T19:34:11.415924-06:00
fest_tracking: true
---
...
```bash
cd projects/contracts && forge test --match-contract ObeyVaultTest -vvv
```
...
```bash
cd projects/contracts && forge coverage
```
