...
fest_created: 2026-03-13T19:27:21.707489-06:00
fest_updated: 2026-03-15T19:40:17.169229-06:00
fest_tracking: true
---
...
```bash
cd projects/agent-defi && go test ./internal/synthesis/... -v -count=1
```
...
```bash
cd projects/agent-defi && go test ./internal/synthesis/... -coverprofile=coverage.out && go tool cover -func=coverage.out
```
