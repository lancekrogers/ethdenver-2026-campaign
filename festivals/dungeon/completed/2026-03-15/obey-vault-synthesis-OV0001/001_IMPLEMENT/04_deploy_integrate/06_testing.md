...
fest_created: 2026-03-13T19:27:21.708145-06:00
fest_updated: 2026-03-15T19:51:56.560461-06:00
fest_tracking: true
---
...
```bash
cd projects/contracts && forge test -v
cd projects/agent-defi && go test ./... -v
```
...
```bash
# Verify on-chain: check Basescan for SwapExecuted events from vault address
...
- Minimum coverage: N/A (integration sequence) for new code

N/A — integration testing uses on-chain verification
