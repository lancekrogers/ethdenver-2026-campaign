...
fest_created: 2026-02-23T11:06:55.278944-07:00
fest_updated: 2026-02-23T13:53:50.400569-07:00
fest_tracking: true
---
...
```bash
cd projects/hiero-plugin && npm test -- --grep "0g"
```
...
```bash
cd projects/hiero-plugin && npm test -- --coverage
```
