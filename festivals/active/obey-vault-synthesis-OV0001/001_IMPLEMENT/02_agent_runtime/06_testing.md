...
fest_created: 2026-03-13T19:27:21.704986-06:00
fest_updated: 2026-03-15T19:39:19.022349-06:00
fest_tracking: true
---
...
```bash
cd projects/agent-defi && go test ./internal/vault/... ./internal/strategy/... ./internal/risk/... ./internal/loop/... -v
```
...
```bash
cd projects/agent-defi && go test ./... -v -count=1
```
...
```bash
cd projects/agent-defi && go test ./internal/... -coverprofile=coverage.out && go tool cover -func=coverage.out
```
