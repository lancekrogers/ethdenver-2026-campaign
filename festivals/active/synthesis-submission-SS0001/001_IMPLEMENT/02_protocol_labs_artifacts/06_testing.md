...
fest_created: 2026-03-16T21:45:43.683878-06:00
fest_updated: 2026-03-17T00:00:25.500398-06:00
fest_tracking: true
---
...
# Validate agent_log.json is valid JSON
python3 -m json.tool agent_log.json
```
...
```bash
# Verify agent.json references match deployed contracts
# Verify agent_log.json entries reference real TxIDs
```
...
- Minimum coverage: N/A (artifact generation, not code) for new code

N/A for artifact generation sequences.
