...
fest_created: 2026-03-16T21:45:43.684745-06:00
fest_updated: 2026-03-17T00:16:17.439239-06:00
fest_tracking: true
---
...
```bash
cd projects/contracts && forge test
```
...
```bash
# Verify all mainnet transactions on Basescan
# Verify vault state reads (balances, boundaries, agent address)
```
...
- Minimum coverage: N/A (deployment sequence, existing tests cover contract logic) for new code

```bash
cd projects/contracts && forge test --gas-report
```
