...
fest_created: 2026-02-23T11:06:55.281662-07:00
fest_updated: 2026-02-23T13:59:37.185967-07:00
fest_tracking: true
---
...
```bash
# Lint markdown files for broken links and formatting
npx markdownlint-cli2 "**/*.md" --fix 2>/dev/null || echo "markdownlint not installed — review manually"
```
