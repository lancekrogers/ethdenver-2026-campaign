...
fest_created: 2026-02-23T11:06:55.273905-07:00
fest_updated: 2026-02-23T13:36:53.740906-07:00
fest_tracking: true
---
...
```bash
cd projects/agent-defi && just test
```
...
```bash
cd projects/agent-defi && just test -run Integration
```
...
```bash
cd projects/agent-defi && go test -coverprofile=coverage.out ./internal/base/... && go tool cover -func=coverage.out
```
