...
- Self-sustaining: covers its own gas costs from trading profit
...
**Trading:** Mean reversion strategy on USDC/WETH via Uniswap V3 SwapRouter on Base Sepolia. Buys 2% below 30-period moving average, sells 2% above. Confidence scales with price deviation. ~$12-16 net profit per trade.
...
**Self-Sustaining:** The agent covers its own gas and operational costs from trading profits. This is not a demo that burns a treasury — it's designed to be economically self-sustaining.
...
3. **Self-sustaining economics** — Proves Base is viable for autonomous agent operations where the agent covers its own costs.
